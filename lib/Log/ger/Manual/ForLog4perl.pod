...
release is in 2002, Log4j is even older), featureful, and quite performant. You
can send logs to multiple outputs, decorate (layout) the message with various
extra information, and filter by level and category. Different outputs can be
applied different filters. You can define your own logging levels.
