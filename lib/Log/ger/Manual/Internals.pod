...
C<< log_warn("blah", $args, ...) >> and converts it to the message (usually
...
(hash, arguments passed to Log::ger when importing, e.g. C<< {category =>
...
Used to construct routine names. Hook must return this (all keys are optional):
 ...
 [{
   ...
   logml_subs    => [ [NAME, undef    ], ... ],
   logml_methods => [ [NAME, undef    ], ... ],
