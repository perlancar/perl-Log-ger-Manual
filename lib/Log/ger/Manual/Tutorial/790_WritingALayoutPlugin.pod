package Log::ger::Manual::Tutorial::79_WritingALayoutPlugin;
...
C<$lnum> is numeric level, C<$lname> is string level. In the example above, we
are only concerned with C<$fmsg> (C<$_[0]>).
...
L<Log::ger::Manual::Tutorial::49_WritingAnOutputPlugin>

L<Log::ger::Manual::Tutorial::69_WritingAFormatPlugin>
