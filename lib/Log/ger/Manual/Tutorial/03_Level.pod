package Log::ger::Manual::Tutorial::03_Level;
...
Another module you can use for this purpose is
L<Log::ger::Plugin::Level::FromEnv>. This module detects some environment
variables (like C<LOG_LEVEL=debug>, or C<TRACE=1>) then set the logging level
according to it.
